    ...
    <body style="background-color: #FEDCDB">
        ...
        <nav class="navbar fixed-top" style="background-color: #0199ff;">
            <div class="container-fluid">
                <a type="button" class="btn border-0 mx-3" href="/order/undangan/ulangtahun/{{ $undangan[0]['_id'] }}" style="background: white; color: #0199ff; font-size: 14px; font-weight: 500">Kembali</a>
