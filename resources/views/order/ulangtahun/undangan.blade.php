    ...
    <div class="card" style="width: 90%;">
        ...
        <div class="card-body d-flex flex-column justify-content-center align-items-center m-5">
            ...
            <div class="row-12">
              ...
              <a href="/order/undangan/ulangtahun/{{ $undangan[0]['_id'] }}/preview" class="btn btn-primary m-2 px-4 shadow border-0" style="background: white; color:#0199ff; font-size: 16px;">Preview</a>
              ...
              @else
                ...
                @else
                  <div class="row-12 d-flex flex-column justify-content-center">
                    ...
                    <p class="fs-4 mt-3">Tautan Undangan: <a href="#">invita.id/ulangtahun/{{ $undangan[0]['slug'] }}</a></p>
                  </div>
                @endif
              @endforeach
              @endif
            ...
            <div class="row gap-4">
                <div class="card justify-content-center" style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <a href="/order/undangan/ulangtahun/{{ $undangan[0]['_id'] }}/edit" class="btn btn-primary shadow border-0" style="font-size: 14px; background:#0199ff;">Edit Data Undangan</a>
                    </div>
                  </div>
                  <div class="card d-flex justify-content-center" style="width: 18rem;">
                    <img src="/img/buku-tamu.png" class="card-img-top p-5" alt="..." style="height: 18rem; object-fit: cover">
                    <div class="card-body">
                      <a href="/order/undangan/ulangtahun/{{ $undangan[0]['_id'] }}/bukutamu" class="btn btn-primary shadow border-0" style="font-size: 14px; background:#0199ff;">Laporan Buku Tamu</a>
                    </div>
                  </div>
            </div>
        </div>
