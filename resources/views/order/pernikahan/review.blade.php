  ...
  <body>
    ...
    <div class="row mt-5">
      <div class="col-10">
        ...
        <h3 class="mb-5">Undangan Pernikahan {{ $data[0]['details'][0]['nama_mempelai_lk'] }} dan {{ $data[0]['details'][0]['nama_mempelai_pr'] }}</h3>
      </div>
    </div>
    
    <form action="/order/undangan/pernikahan/review/{{ $data[0]['_id'] }}" method="post">
      @csrf
    <div class="row mt-4">
